...
local mykeyboardlayout = {
    ...
    fg = catpuccin.night.black2,
    bg = catpuccin.morning.red,
...
awful.screen.connect_for_each_screen(function(s)
    ...
    s.mytaglist = awful.widget.taglist {
        ...
        style  = {
            fg_focus = catpuccin.night.white,
            bg_focus = catpuccin.night.black3,
        },
    ...
    s.mytasklist = awful.widget.tasklist {
        ...
        style = {
            fg_normal = catpuccin.morning.white,
            bg_normal = catpuccin.night.black0
        },
        widget_template = {
            {
                {
    ...
    s.mywibox = awful.wibar({ 
        position = "top", 
        screen = s,
        fg = catpuccin.night.gray1,
        bg = catpuccin.night.black0,
        border_width = 2,
        border_color = catpuccin.morning.sky
    })
